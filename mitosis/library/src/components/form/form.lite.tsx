    ...
    return (
        <form>
            <div className="flex w-full flex-col lg:flex-row">
                {Array((props.component as TicketComponentForm).getOptions().columns).fill(0).map((e,i)=>{
                    return (props.component as TicketComponentForm).getValue()
                    .getValue().filter((_e, _i)=>{
                        if ((_i+1)%i == 0){
