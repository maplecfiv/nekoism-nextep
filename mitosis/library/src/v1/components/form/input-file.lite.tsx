            ...
            <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                <div class="text-center">
                    ...
                    <div class="mt-4 flex text-sm/6 text-gray-600">
                        ...
                        <p class="pl-1">#component.inputFilePicker.label.drop</p>
                    </div>
                    <Show when={props.component.getOption().acceptedExtensions.length > 0 || props.component.getOption().acceptedFileSize != -1}></Show>
                    <p class="text-xs/5 text-gray-600">
                        {props.component.getOption().acceptedExtensions.join(', ')}
                        <Show when={(props.component.getOption().acceptedFileSize != -1)}>
                            #component.inputFilePicker.label.fileSize {props.component.getOption().acceptedFileSize}
                        </Show>
                    </p>
                </div>
            </div>
